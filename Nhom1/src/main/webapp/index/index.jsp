...
<div class="row" style="margin: 0px;padding: 0px">
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active c-item img-fluid">
                <img src="/index/img/1.jpg" class="d-block w-100 c-img" alt="Slide 1">
            </div>
            <div class="carousel-item c-item img-fluid">
                <img src="/index/img/2.jpg" class="d-block w-100 c-img" alt="Slide 2">
            </div>
            <div class="carousel-item c-item img-fluid">
                <img src="/index/img/3.jpg" class="d-block w-100 c-img" alt="Slide 3">
            </div>
        </div>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item carousel-item active">
                        <div class="img-box"><img src="/index/img/nd1.jpg" alt=""></div>
                        <p class="testimonial">Bia đỉnh, giao hàng nhanh</p>
                        <p class="overview"><b>Phan Văn Đồng</b>, Quảng Trị</p>
                    </div>
                    <div class="item carousel-item">
                        <div class="img-box"><img src="/index/img/nd2.jpg" alt=""></div>
                        <p class="testimonial">Bia đỉnh, giao hàng nhanh</p>
                        <p class="overview"><b>Lê Văn Phát Đạt</b>, Huế</p>
                    </div>
                    <div class="item carousel-item">
                        <div class="img-box"><img src="/index/img/nd3.jpg" alt=""></div>
                        <p class="testimonial">Bia đỉnh, giao hàng nhanh</p>
